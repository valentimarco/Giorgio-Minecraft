...
<template>
    <div class="grid grid-rows-[1fr_3rem] overflow-hidden">
                <UStepper ref="stepper" :items="items" size="xl" class="">
                        ...
                        <div class="grid grid-cols-[10rem_1fr] border-1 rounded-lg p-2 m-2 h-full">
                            <div class="flex flex-col p-2 gap-1 m-2">
                                ...
                                <div v-else class="flex justify-center">
                                    <div ref="dropZone" class="flex justify-center items-center border border-dashed w-full" @click="open">
                    ...
                    <template #config>
                        <UForm :schema="serverWizardSchema" :state="wizardModel" class="space-y-4 h-full">
                            <div class="grid border-1 rounded-lg p-2 m-2 h-full">
                    ...
                    <template #confirm>
                        <div class="grid grid-rows-[1fr_5rem] border-1 rounded-lg p-2 m-2 h-full">
                            <div class="grid border-1 rounded-lg p-2 m-2 h-full">
                                ...
                                <div class="grid justify-evenly m-2 p-2 gap-y-5 h-full">
                                    <UFormField label="Type" size="xl">
                                        <UInput v-model="wizardModel.type" disabled />
                                    </UFormField>
                            ...
                            <div class="flex flex-col p-2 mt-4 items-center">
                                <UButton class="w-[10rem]" icon="i-material-symbols-settings" label="View More" :ui="{ label: 'text-center w-full text-xl'}" size="sm"/>
                            </div>
                        </div>
                    </template>
                </UStepper>
                ...
                <div class="flex gap-2 justify-around mt-4">
                    ...
                    <UButton v-else trailing-icon="i-lucide-plane-takeoff"
                        @click="createServer">
                        Create
                    </UButton>
                </div>
